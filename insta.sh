#!/bin/bash
# FB by: https://www.youtube.com/user/umeshpince
# Instagram: @cyberspidy19
...
printf "\e[1;92m _  | | https://www.youtube.com/user/umeshpince\e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____              \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ |  Umesh      \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____      \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (_____)     \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.5 Author: Umesh Shinde (Github/IG)   \e[0m\n"
printf "\n"
}
